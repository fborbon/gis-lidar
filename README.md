...
This is a demonstrator built to show what a rigorous, general-purpose geospatial AI project looks like: applying domain-specific GIS/remote-sensing expertise to build, and independently evaluate, an AI system's understanding of geospatial concepts. Rather than run NDVI on a Sentinel-2 tile and call it a day, the goal was to show the full geospatial ML lifecycle end to end: real raster and vector data in their native, awkward forms, real coordinate reference systems that don't quite line up, real multimodal fusion, real GIS-aware evaluation (not just pixel accuracy), and a genuine attempt at a skill that matters for this kind of work: evaluating whether an AI's answer about GIS/remote-sensing concepts is actually correct.
